...
public class CameraChooseImagesSupplyAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CameraChooseImagesSupplyAdapter(Context mContext, List<ChooseImages> mList, List<Uri> chooseImagesURI) {
        this.mList = mList;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View v1 = inflater.inflate(R.layout.camera_choose_image_row, parent, false);
