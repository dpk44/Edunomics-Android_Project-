...
class BridgeViewModel(
    ...
    fun getMaxSelectionLimit() =
        galleryConfig.validation.getMaxPhotoSelectionRule().maxSelectionLimit

    fun getMaxVideoSelectionLimit() =
        galleryConfig.validation.getMaxVideoSelectionRule().maxSelectionLimit
    ...
    fun getMaxVideoLimitErrorResponse() =
