...
class GalleryConfig(
    ...
    fun shouldOnlyValidatePhoto() =
        typeOfMediaSupported == MediaType.PhotoWithFolderOnly || typeOfMediaSupported == MediaType.PhotoOnly

    fun isGalleryInitialize() = applicationContext != null && clientAuthority != null


    class GalleryNotInitilizedException(message: String = "Please initialize gallery with application and client authority") :
        Exception(message)
    ...
    class GalleryConfigBuilder(
        ...
        fun useMyPhotoCamera(shouldUseMyCamera: Boolean) =
            apply { this.shouldUsePhotoCamera = shouldUseMyCamera }

        fun useMyVideoCamera(shouldUseMyCamera: Boolean) =
            apply { this.shouldUseVideoCamera = shouldUseMyCamera }

        fun needToShowCover(needToShowCover: Boolean) =
            apply { this.needToShowCover = needToShowCover }

        fun photoViewPlaceHolder(layout: Int) = apply { this.photoViewPlaceHolder = layout }
        fun typeOfMediaSupported(mediaType: MediaType) =
            apply { this.typeOfMediaSupported = mediaType }
        ...
        fun mediaScanningCriteria(mediaScanningCriteria: MediaScanningCriteria) =
            apply { this.mediaScanningCriteria = mediaScanningCriteria }
    ...
    data class MediaScanningCriteria(
        val photoBrowseQuery: String = "",
        val videoBrowseQuery: String = ""
    ) {
